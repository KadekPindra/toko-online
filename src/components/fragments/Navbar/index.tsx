...
const Navigation = () => {
  ...
  return (
    <>
      <nav
        className={`w-full bg-white px-8 py-4 flex justify-between md:justify-center md:items-center md:gap-5 fixed transition-all duration-500 ${
          isBlurred ? "bg-transparent backdrop-filter backdrop-blur-lg" : ""
        }`}
      >
